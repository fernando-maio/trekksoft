...
3. Grant permissions to bootstrap/cache and storage paths.
4. Run: composer install.
5. To run locally, run: php artisan serve --port=8080, and test on localhost:8080.
6. To run the tests, open the project on terminal and run: php artisan test
